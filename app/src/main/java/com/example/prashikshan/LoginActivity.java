...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    mAuth.signInWithEmailAndPassword(email, password)
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    {
                                        Intent intent = new Intent(LoginActivity.this, com.example.prashikshan.LoginActivity.class);
        ...
        btnOpenRegistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Launch intent.
                Intent intent = new Intent(LoginActivity.this, com.example.prashikshan.RegistrationActivity.class);
                startActivity(intent);
                LoginActivity.this.finish();
            }
        });
    ...
    protected void onStart() {
        ...
        {
            Intent intent = new Intent(LoginActivity.this, com.example.prashikshan.UserProfile.class);
