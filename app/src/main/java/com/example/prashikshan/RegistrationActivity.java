...
public class RegistrationActivity extends AppCompatActivity {
    EditText etSignUpUsername, etSignUpEmail, etSignUpPassword, etInstitution, etClass, etConfirmPassword, etSubject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOpenLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                etConfirmPassword.setText("");
                //Intent launch.
                Intent intent = new Intent(RegistrationActivity.this, com.example.prashikshan.LoginActivity.class);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.isEmpty() || email.isEmpty() ||class_name.isEmpty() || institution.isEmpty() || password.isEmpty() || confirm_password.isEmpty() || subject.isEmpty())
                {
                    if(username.isEmpty())
                    {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if(task.isSuccessful())
                                    {
                                        ...
                                        Faculty faculty = new Faculty(username, email, institution, class_name, subject);
                                        ...
                                        mDatabase.child(mAuth.getCurrentUser().getUid()).setValue(faculty)
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if(task.isSuccessful())
                                                        {
                                                            ...
                                                            Intent intent = new Intent(RegistrationActivity.this, com.example.prashikshan.UserProfile.class);
